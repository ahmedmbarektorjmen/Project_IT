...
class User(Base):
    ...
    profile_pic = Column(String(255),nullable=False,server_default="/files/profile_images/default.png")
...
class Product(Base):
    ...
    stars_count = Column(Integer,nullable=False,server_default="0")
    stars_sum = Column(DECIMAL(10,2),nullable=False,server_default="0.00")
